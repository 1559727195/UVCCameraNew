...
Java_com_massky_uvccamera_CameraPreview_prepareCamera(JNIEnv *env, jobject thiz, jint videoid) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_massky_uvccamera_CameraPreview_prepareCameraWithBase(JNIEnv *env, jobject thiz,
                                                              jint videoid, jint videobase) {
    int ret;

    camerabase = videobase;

    return Java_com_massky_uvccamera_CameraPreview_prepareCamera(env,thiz,videoid);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_massky_uvccamera_CameraPreview_pixeltobmp(JNIEnv *env, jobject thiz, jobject bitmap) {
